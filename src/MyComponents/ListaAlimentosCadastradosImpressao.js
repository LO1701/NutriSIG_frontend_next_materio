...
const ListaAlimentosCadastradosImpressao = ({id}) => {
  ...
  return (
    <>
        {alimentoCadastrado?.length > 0 ? (
            ...
            <Typography variant="subtitle1" gutterBottom sx={{ display: 'flex', justifyContent: 'center', margin: 10, color: '#000' }}>
...
export default ListaAlimentosCadastradosImpressao